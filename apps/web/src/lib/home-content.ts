...
export const HOME_FAQ = [
  {
    ...
    answer:
      "Landing e funil: em geral até 72h após o orçamento aprovado. Escopo maior com marcos definidos.",
  },
  {
    id: "projeto",
    question: "É cópia de template?",
    answer:
      "Não. Amostras mostram nível visual. Cada entrega é exclusiva para o seu nicho.",
  },
] as const;
...
export const CINEMATIC_BAND = {
  ...
  subtitle:
    "Site, captura, WhatsApp e métricas — o que seu cliente leva para o mercado.",
...
export const PRODUCT_DEMO = {
  ...
  steps: [
    "Lead entra com mensagem certa",
    "WhatsApp no timing",
    "Origem no CRM",
    "Métrica sem planilha",
  ],
} as const;
  ...
  steps: [
    {
      num: "01",
      title: "Orçamento",
      desc: "Entendemos nicho, meta e investimento.",
    },
    { num: "02", title: "Obra", desc: "Site, funil e integrações no ar." },
    {
      num: "03",
      title: "Ritmo",
      desc: "Automação e relatório do que converte.",
    },
  ],
} as const;
...
export const HERO_COPY = {
  subhead:
    "Sites, plataformas, apps e funis sob medida — do primeiro clique à venda, com previsibilidade.",
...
export const GUARANTEE_SEALS = [
  {
    ...
    description:
      "Ajustes críticos no escopo acordado na primeira semana após a entrega.",
  },
  {
    id: "resposta-24h",
    title: "Resposta em 24h",
    description:
      "Orçamento e próximos passos com prazo claro no WhatsApp ou e-mail.",
  },
  {
    id: "sem-fidelidade",
    title: "Sem fidelidade forçada",
    description:
      "Planos com transparência — você decide renovar conforme o resultado.",
  },
] as const;
  ...
  categories: [
    {
      tag: "Construir",
      title: "Presença",
      items: ["Landing sob medida", "Copy do nicho"],
    },
    {
      tag: "Operar",
      title: "Funil",
      items: ["WhatsApp integrado", "CRM + métricas"],
    },
  ],
} as const;
