...
export const PEXELS = {
    ...
    // Unique video IDs — sem repetição entre canais
    salesFunnel: pexelsHd(6774814),   // operações de negócio / funil — único
    salesTeam: pexelsHd(3205574),     // equipe de vendas reunião — único
    manifesto: pexelsHd(3943445),     // gráficos/crescimento — igual ao profCharts mas diferente de salesFunnel
} as const;
