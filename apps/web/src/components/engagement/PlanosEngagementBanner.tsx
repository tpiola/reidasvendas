...
export function PlanosEngagementBanner() {
  ...
  return (
    <div className="fixed bottom-24 left-5 right-5 z-[54] mx-auto max-w-lg md:left-auto md:right-24">
      <div className="glass-card flex flex-col gap-3 rounded-2xl border border-[#C9A84C]/25 p-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm text-surface-muted">
          <span className="font-semibold text-surface">Ainda em dúvida?</span> Orçamento em 24h com escopo fechado.
        </p>
        <div className="flex shrink-0 gap-2">
          ...
          <button
            type="button"
            className="h-10 px-3 text-surface-muted hover:text-[color:var(--page-fg)]"
            aria-label="Fechar"
