        ...
        >
          {testimonials.map((t) => (
            <motion.div
              ...
              className="group relative rounded-2xl border border-[rgba(166,111,24,0.1)] bg-gradient-to-br from-[rgba(166,111,24,0.02)] to-[rgba(10,22,40,0.1)] p-6 sm:p-7 transition-all duration-500 hover:border-[#D4AF37]/30 hover:shadow-[0_0_40px_rgba(166,111,24,0.08)]"
            >
              {/* Gold border accent */}
              <div className="absolute inset-0 rounded-2xl border border-[rgba(166,111,24,0.15)] opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none" />
              <div className="absolute -inset-px rounded-2xl bg-gradient-to-b from-[rgba(166,111,24,0.08)] to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none" />

              <div className="relative z-10">
                {/* Quote icon */}
                <Quote className="mb-4 h-8 w-8 text-[rgba(166,111,24,0.15)]" />
                ...
                {/* Result highlight */}
                <div className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-[rgba(166,111,24,0.08)] px-3 py-1 text-[10px] font-bold text-gold">
                  <Sparkles className="h-2.5 w-2.5" />
                  {t.highlight}
                </div>

                {/* Author */}
                <div className="mt-5 flex items-center gap-3 border-t border-[rgba(166,111,24,0.06)] pt-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[rgba(166,111,24,0.15)] to-[rgba(166,111,24,0.05)] text-sm font-bold text-gold">
                    {t.name.charAt(0)}
                  </div>
                  <div>
