...
export function SiteFooter() {
  return (
    <footer className="relative overflow-hidden border-t border-[#C9A84C]/20 bg-[#030305] text-white">
      <div
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-14 pt-16 md:pt-20">
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-10">
          <Reveal delay={0.05} className="lg:col-span-4">
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 text-sm text-white/55 transition-colors hover:text-[#C9A84C]"
            >
          ...
          <Reveal delay={0.2} className="flex flex-col items-center lg:col-span-3 lg:items-end">
            <p className="mb-4 text-center text-[10px] font-bold uppercase tracking-[0.28em] text-white/35 lg:text-right">
              Fale agora
            </p>
            <FooterWhatsAppQr />
            <a
        ...
        <Reveal delay={0.12} className="mt-16">
          <div className="rounded-2xl border border-white/[0.08] bg-gradient-to-r from-[#0057FF]/12 via-[#030305] to-[#C9A84C]/10 p-8 md:flex md:items-center md:justify-between md:gap-8">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-[#C9A84C]/80">Diagnóstico</p>
              <p className="mt-2 text-lg font-semibold text-white">Resposta em até 24h</p>
