...
export function PlanComparisonTable({ currentSlug }: PlanComparisonTableProps) {
  ...
  return (
    <Reveal className="mt-16">
      <h2 className="text-xl font-semibold text-white">Compare com outros planos</h2>
      <p className="mt-2 text-sm text-white/45">Preços e escopo completos em cada página — escolha o ritmo do seu negócio.</p>
