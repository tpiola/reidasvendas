...
const RECURSOS = [
  {
    ...
    color: 'from-gold/20 to-gold-light/5',
  },
  {
    ...
    color: 'from-gold/15 to-gold-dark/5',
  },
  {
...
function FaqItem({ q, a, index }: { q: string; a: string; index: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <p className="px-5 pb-5 text-sm leading-relaxed text-text-secondary sm:px-6 sm:pb-6 sm:pl-16">
          {a}
        </p>
      </motion.div>
    </motion.div>
          ...
          <Reveal delay={0.25}>
            <div className="mt-6 flex flex-wrap justify-center gap-3 text-sm text-text-muted">
              <span className="flex items-center gap-1.5">
                <BookOpen className="h-4 w-4 text-gold" /> Guias Completos
              </span>
              <span className="hidden sm:inline text-[rgba(28,25,20,0.12)]">•</span>
              <span className="flex items-center gap-1.5">
                <ClipboardList className="h-4 w-4 text-gold" /> Templates Práticos
              </span>
              <span className="hidden sm:inline text-[rgba(28,25,20,0.12)]">•</span>
              <span className="flex items-center gap-1.5">
                <Download className="h-4 w-4 text-gold" /> Downloads Gratuitos
              </span>
            </div>
          </Reveal>
        </div>
            ...
            {RECURSOS.map((recurso) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-text-secondary">{recurso.desc}</p>
                  ...
                  <div className="mt-5 pt-4 border-t border-line">
                    <span className="inline-flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.12em] text-gold transition-all duration-300 group-hover:gap-2.5">
            ...
            <div className="mt-10 text-center">
              <p className="text-sm text-text-muted">
                ...
                <a
                  ...
                  className="font-semibold text-gold underline underline-offset-2 transition-colors hover:text-gold-light"
                >
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6">
          ...
          <Reveal delay={0.2}>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-xs text-text-muted">
              <span className="flex items-center gap-1.5">
                <Star className="h-3.5 w-3.5 text-gold" /> Conteúdo Exclusivo
              </span>
              <span className="flex items-center gap-1.5">
                <Shield className="h-3.5 w-3.5 text-gold" /> 100% Gratuito
              </span>
              <span className="flex items-center gap-1.5">
                <Zap className="h-3.5 w-3.5 text-gold" /> Aplicação Imediata
              </span>
            </div>
          </Reveal>
        </div>
