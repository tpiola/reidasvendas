...
const P = {
  ...
  estetica2: "photo-1522337360788-8b13dee7a37e",
...
export const TEMPLATES: TemplateDefinition[] = [
  {
    ...
    galleryImageUrls: [
      catalogCover(P.estetica2, 1600, 1200),
      catalogCover(P.estetica, 1600, 1200),
    ],
  ...
  },
  {
    ...
    galleryImageUrls: [
      catalogCover("photo-1521737604893-d14cc237f11d", 1600, 1200),
    ],
